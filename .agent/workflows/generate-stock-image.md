...
> ⛔ **체크포인트: 아래 항목을 채우지 않으면 다음 단계 진행 금지**

| 항목 | 분석 결과 (직접 작성) |
|------|---------------------|
| 오브젝트 | _________________ |
| 배경/장소 | _________________ |
| 분위기 | _________________ |
| 색상 | _________________ |
| 조명 | _________________ |
| 구도 | _________________ |

**이미지를 직접 보고 분석하여 위 표를 채울 것.**

> ⛔ **키워드 체크포인트: 분석 결과 기반으로 반드시 25~35개 키워드를 작성할 것. 10개 이하는 절대 금지!**
> - Tier 1 (1~10번): 핵심 오브젝트, 분위기, 시즌 (가장 중요)
> - Tier 2 (11~25번): 장소/배경, 색상/조명, 스타일
> - Tier 3 (26~35번): 용도(banner, background, poster), 감정, 관련 개념
